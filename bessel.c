// implementation of the Bessel functions of the first and second kind
// 
// based on FreeBSD libm code by Sun Microsystems
...
#define GET_HIGH_WORD(i, d) \
    do { \
        uint64_t r = ((union { double v; uint64_t r; }){ d }).r; \
        (i) = (uint32_t)(r >> 32); \
    } while(0)
